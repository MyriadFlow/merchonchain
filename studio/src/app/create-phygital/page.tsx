				...
				<Form {...form}>
					<form onSubmit={form.handleSubmit(onSubmit)}>
						<div className='py-4 px-32 flex flex-col gap-12'>
							<h2 className='text-xl font-bold'>Chain: Polygon Network</h2>
							...
							<div>
								<label className='flex items-center text-xl'>
									<input
										...
										className='mr-2 '
									/>
									This phygital is available only as merch on site (not online)
								</label>
								{showForm && (
									<div className='mt-6'>
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										<FormLabel className='text-xl font-semibold mb-4'>
										Product and/or Event Information for AI*
										</FormLabel>
										<FormDescription>
										Fill this field if you want to create an AI-powered brand ambassador
										</FormDescription>
										<Textarea placeholder="Give as much information as possible about your product. Anything you want the AI avatar to know and share with your customers." 
										className='border-0 bg-[#0000001A]' {...field} />
									</FormItem>
								)}
							/>
